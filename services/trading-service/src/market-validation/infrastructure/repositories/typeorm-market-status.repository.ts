...
import { MarketExchange } from '../../../market/domain/entities/market-exchange.entity';
import { MarketValidationEvent } from '../../domain/entities/market-validation-event.entity';
import { evaluateMarketSession } from '../../domain/services/market-session-clock';
import type {
  MarketSchedule,
  MarketStatusRepository,
  MarketValidationResult,
} from '../../domain/repositories/market-status.repository';

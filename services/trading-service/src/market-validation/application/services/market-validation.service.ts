...
import { MarketValidation } from '../../domain/entities/market-validation.entity';
import { MARKET_STATUS_REPOSITORY } from '../../domain/repositories/market-status.repository';
import type { MarketStatusRepository } from '../../domain/repositories/market-status.repository';

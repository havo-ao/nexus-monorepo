...
import { FundsValidationEvent } from '../../../funds-validation/domain/entities/funds-validation-event.entity';
...
import { TradingOrderEntity } from '../../domain/entities/trading-order.entity';
import type {

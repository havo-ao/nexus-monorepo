...
import { PortfolioPosition } from '../../portfolio/entities/portfolio-position.entity';
import { HoldingsValidationEvent } from '../entities/holdings-validation-event.entity';
import type {
  HoldingsValidationResult,
  TraderHoldingsRepository,
} from './trader-holdings.repository';
